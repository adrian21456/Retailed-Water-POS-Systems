...
<div>
	<form method="post" action="updateRefill.php">
		<div class="row">
			<div class="col-md-6">
				<div class="col-md-12 mtop-10">
					<div class="input-group">
						<span class="input-group-addon">Type of Container</span>
						<input id="costC" type="text" name="type" class="input-form text-center" value="<?php echo $row['wType'] ?>" required>
						<input type="hidden" name="id" class="input-form text-center" value="<?php echo $row['wType_id'] ?>" >
					</div>
				</div>
				<div class="col-md-10 mtop-10">
					<div class="input-group">
						<span class="input-group-addon">Price</span>
						<input id="costC" type="number" name="price" class="input-form text-center" value="<?php echo $row['wCost'] ?>" required>
